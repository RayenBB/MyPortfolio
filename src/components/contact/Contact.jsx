...
import "./contact.css";
import { HiOutlineMail, HiOutlineArrowSmRight, HiOutlineDeviceMobile } from "react-icons/hi"
...
const Contact = () => {
    ...
    const sendEmail = (e) => {
        ...
        emailjs.sendForm('service_rhn6fje', 'template_tmdoe6f', form.current, '9d63_lZWYrcLc2z7C')
        e.target.reset();
    };
            ...
            <div className="contact__content">
                ...
                <div className="contact__info">
                    <div className="contact__card">
                        ...
                        <span className="contact__card-data">rayen.benboubaker@etudiant-enit.utm.tn</span>
                        
                        <a href="mailto:rayen.benboubaker@etudiant-enit.utm.tn" className="contact__button">
                            Write Me{" "} 
                            <HiOutlineArrowSmRight className="contact__button-icon" />
                        </a>
                    </div>
                    <div className="contact__card">
                        <HiOutlineDeviceMobile className="contact__card-icon" />
                        
                        <h3 className="contact__card-title">Mobile</h3>
                        <span className="contact__card-data">25149625</span>
